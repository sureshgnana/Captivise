...
AliasMatch ^/manual(?:/(?:da|de|en|es|fr|ja|ko|pt-br|ru|tr|zh-cn))?(/.*)?$ "/tmp/pip-install-pccui0fu/mod-wsgi-httpd_24e24bf968d246e2868d4697e70098e1/build/httpd/manual$1"

<Directory "/tmp/pip-install-pccui0fu/mod-wsgi-httpd_24e24bf968d246e2868d4697e70098e1/build/httpd/manual">
    Options Indexes
    AllowOverride None
    Require all granted
